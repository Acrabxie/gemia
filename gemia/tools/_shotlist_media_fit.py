...
def fit_media_for_context(
    ...
    def provider(query: str, _shot: dict[str, Any]) -> dict[str, Any]:
        raw = search_media_annotations(account_id, query, kind="video", limit=20, project_id=project_id)
        ...
        for result in raw.get("results") or []:
            ...
            enriched["annotations"] = list_annotations(account_id, library_asset_id, project_id=project_id)
